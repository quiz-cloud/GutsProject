...
public:
	...
	static void SpawnNodeFromAsset(UAnimationAsset* Asset, const FVector2f& GraphPosition, UEdGraph* Graph, UEdGraphPin* PinIfAvailable);
...
private:
	...
	static FVector2f GetFixedOffsetFromPin(const UEdGraphPin* InHoverPin);
};
